...
HUMAN_TRANSLATION_MAP = {
    ...
    "review4_ai_fail": "%s未过：三AI理论复核" % lex.REVIEW_4,
    "ai_theoretical_review_required": "%s未过：三AI理论复核缺失" % lex.REVIEW_4,
    "review3_fail": "%s未过：矩阵验证 / 抗离群" % lex.REVIEW_3,
    ...
    "r1": lex.pipe_label("r1"),
    "r2": lex.pipe_label("r2"),
    "r3": lex.pipe_label("r3"),
    "r4": lex.pipe_label("r4"),
    "human": lex.pipe_label("human"),
    "success": "四复核（含三AI）均已通过，策略待%s" % lex.HUMAN_CONFIRM_GATE,
    "idle": "卡槽空闲，等待新机制入队",
    "queued": "已入队，等待空闲卡槽",
    "archived": "已归档极限",
