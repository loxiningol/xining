...
8. vol_z20 / vol_ma20_ratio 阈值以机制包为准：rolling_4h_sweep_5m* 用 vol_ma20_ratio≥1.15；
   macro_sfp_unblocked* 允许 vol_z≥0.8；asia_sweep_fade* 允许 vol_z≥1.5；
   session_liq_engulf* 保持 vol_z≥1.8。不得把阈值降到该机制包声明下限以下。
